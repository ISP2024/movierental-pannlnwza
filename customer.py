...
class Customer:
    ...
    def get_total_rental_points(self):
        """Calculate the total frequent renter points for the customer."""
        total_rental_points = 0
        for rental in self.rentals:
            total_rental_points += rental.get_rental_points()
        return total_rental_points

    def total_charge(self):
        """Calculate the total charge of the rentals."""
        total = 0
        for rental in self.rentals:
